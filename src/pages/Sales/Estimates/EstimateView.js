            ...
            <div className="container mb-5">
              <div className="row mt-3">
                ...
                <div className="col-md-6 col-12 d-flex justify-end flex-column align-items-end mt-2">
                  {datas && (
                    <>
                      <h1>Estimates Invoice</h1>
                      <h3>{customer(datas.customerId) || ""}</h3>
                      <span className="text-muted mt-4">Order Date</span>
                      <h3>{datas?.issueDate?.split("-").reverse().join("-") || "N/A"}</h3>
                    </>
                  )}
                </div>
              </div>
                      ...
                      <>
                        ...
                        <div className="col-6">
                          <p className="text-muted text-sm">
                            {datas.expiryDate?.split("-").reverse().join("-") || "N/A"}
                          </p>
                        </div>
                      </>
                    )}
                ...
                <div className="table-responsive">
                  <table className="table">
                    ...
                    <tbody className="table-group">
                      {datas &&
                        datas.quotesItemsModels &&
                        datas.quotesItemsModels.map((item, index) => (
                          <tr key={index}>
