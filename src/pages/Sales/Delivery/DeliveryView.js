                  ...
                  <div className="hstack gap-2 justify-content-start">
                    ...
                    <ul className="dropdown-menu">
                      <li
                        ...
                        onClick={() => GeneratePdf("download",data,{ name: "DELIVERY" })}
                      >
                        Download PDF
                      </li>
                      <li className="dropdown-item" onClick={() => GeneratePdf("open",data,{ name: "DELIVERY" })}>
                        Open PDF
                      </li>
                      <li
                        className="dropdown-item"
                        onClick={() => GeneratePdf("print",data,{ name: "DELIVERY" })}
                      >
                        Print PDF
                      </li>
                    </ul>
