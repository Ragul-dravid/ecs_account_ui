                                            ...
                                            <tr key={index}>
                                                ...
                                                <td>
                                                    <select
                                                        ...
                                                        {...formik.getFieldProps(`txnCreditNoteItems[${index}].item`)}
                                                ...
                                                <td>
                                                    <input
                                                        ...
                                                        className="form-control"
                                                        {...formik.getFieldProps(`txnCreditNoteItems[${index}].qty`)}
                                                    />
                                                </td>
                                                <td>
                                                    <input
                                                        ...
                                                        className="form-control"
                                                        {...formik.getFieldProps(`txnCreditNoteItems[${index}].price`)}
                                                    />
                                                </td>
                                                <td>
                                                    <input
                                                        ...
                                                        className="form-control"
                                                        {...formik.getFieldProps(`txnCreditNoteItems[${index}].discount`)}
                                                    />
                                                </td>
                                                <td>
                                                    <input
                                                        ...
                                                        className="form-control"
                                                        {...formik.getFieldProps(`txnCreditNoteItems[${index}].taxRate`)}
                                                    />
                                                </td>
                                                <td>
                                                    <input
                                                        ...
                                                        className="form-control"
                                                        {...formik.getFieldProps(`txnCreditNoteItems[${index}].amount`)}
                                                    />
                                                </td>
                                            </tr>
                                        ))}
