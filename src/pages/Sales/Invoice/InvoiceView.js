                  ...
                  <div className="col-auto">
                    <div className="hstack gap-2 justify-content-start">
                      ...
                      <li
                        ...
                        onClick={() => GeneratePdf("download",data,{ name: "INVOICE" })}
                      >
                        Download PDF
                      </li>
                      <li className="dropdown-item" onClick={() => GeneratePdf("open",data,{ name: "INVOICE" })}>
                        Open PDF
                      </li>
                      <li
                        className="dropdown-item"
                        onClick={() => GeneratePdf("print",data,{ name: "INVOICE" })}
                      >
                        Print PDF
                      </li>
                    </ul>
