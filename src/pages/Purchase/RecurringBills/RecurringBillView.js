          ...
          <div className="row align-items-center">
            <div className="col">
              <div className="d-flex align-items-center gap-4">
                <h1 className="h4 ls-tight headingColor">View Recurring Bill</h1>
              </div>
            </div>
                ...
                {recurringBill && (
                  <>
                    ...
                    <span style={{ color: "#2196f3" }}>
                      {recurringBill.customerName || ""}
                    </span>
                    <p className="fw-small">
                      {recurringBill.customerAddress || "Address not available"}
                    </p>
                  </>
                )}
              </div>
              ...
              <table className="table">
                ...
                <tbody className="table-group">
                  {recurringBill &&
                    ...
                    recurringBill.recurringBillItemModels.map((item, index) => (
                      <tr key={index}>
              ...
              {recurringBill && (
                <>
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-sm-6">₹{recurringBill.total || "0"}</div>
                  </div>
                </>
              )}
            </div>
              ...
              <>
                ...
                <div className="col-md-6 col-12">
                  <div className="d-flex justify-content-center flex-column align-items-start">
                    ...
                    <p className="fw-small">{recurringBill.cusNotes || ""}</p>
                  </div>
                </div>
              </>
            )}
